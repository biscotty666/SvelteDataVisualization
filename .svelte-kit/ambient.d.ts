...
declare module '$env/static/private' {
	...
	export const CMDSTAN_OLD: string;
	...
	export const npm_package_dependencies_ajax: string;
	export const npm_config_version_tag_prefix: string;
	export const STRINGS: string;
	export const npm_package_dependencies_topojson_simplify: string;
	...
	export const npm_package_dependencies_sveltestrap: string;
	...
	export const npm_package_dependencies_topojson_server: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_ajax: string;
		npm_config_version_tag_prefix: string;
		STRINGS: string;
		npm_package_dependencies_topojson_simplify: string;
		...
		CFLAGS: string;
		npm_package_dependencies_sveltestrap: string;
		GCC_AR: string;
		DISPLAY: string;
		LANG: string;
		DEBUG_CFLAGS: string;
		...
		npm_package_dependencies_topojson_server: string;
